...
* **Calculate percent richness change** at a specific stream size: When an `"xval"` parameter is supplied, the function will calculate the percent change in richness 
